...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CommandScheduler.getInstance().onCommandInitialize(command ->
            logger.info("Initialized command '{}'", command.getClass().getSimpleName()));

    // whenever a command ends, the function declared below will run.
    CommandScheduler.getInstance().onCommandFinish(command ->
            logger.info("Ended command '{}'", command.getClass().getSimpleName()));

    // whenever a command ends, the function declared below will run.
    CommandScheduler.getInstance().onCommandInterrupt(command ->
            logger.info("Interrupted command '{}'", command.getClass().getSimpleName()));
